...
mc_error=(Pred_table[1,1]+Pred_table[2,2])/sum(Pred_table)
data2_2=data.frame(data$Plasma,data$Age,Prob)
plot.window(xlim = )
plot(data2_2[data2_2$Prob>=r,2],data2_2[data2_2$Prob>=r,1],col="red")
points(data2_2[data2_2$Prob<r,2],data2_2[data2_2$Prob<r,1],col="blue")
