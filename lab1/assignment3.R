...
## task1
plot(data[data$Diabetes==0,ncol(data)-1],data[data$Diabetes==0,2],col="blue",xlab = "Age",ylab="Plasma glucose concentration")
...
#plot(data[data$Diabetes==0,ncol(data)-1],data[data$Diabetes==0,2],col="blue",xlab = "Age",ylab="Plasma glucose concentration")
#points(data[data$Diabetes==1,ncol(data)-1],data[data$Diabetes==1,2],col="red")
plot(data2_2[data2_2$Prob>=r1,2],data2_2[data2_2$Prob>=r1,1],col="red",xlim = range(min(data2_2$data.Age),max(data2_2$data.Age)),ylim = range(min(data2_2$data.Plasma),max(data2_2$data.Plasma)),xlab = "Age",ylab="Plasma glucose concentration")
...
plot(data2_2[data2_2$Prob>=r2,2],data2_2[data2_2$Prob>=r2,1],col="red",xlim = range(min(data2_2$data.Age),max(data2_2$data.Age)),ylim = range(min(data2_2$data.Plasma),max(data2_2$data.Plasma)),xlab = "Age",ylab="Plasma glucose concentration")
...
plot(data2_2[data2_2$Prob>=r3,2],data2_2[data2_2$Prob>=r3,1],col="red",xlim = range(min(data2_2$data.Age),max(data2_2$data.Age)),ylim = range(min(data2_2$data.Plasma),max(data2_2$data.Plasma)),xlab = "Age",ylab="Plasma glucose concentration")
...
plot(data5_2[data5_2$Prob>=r1,2],data5_2[data5_2$Prob>=r1,1],col="red",xlim = range(min(data5_2$data.Age),max(data5_2$data.Age)),ylim = range(min(data5_2$data.Plasma),max(data5_2$data.Plasma)),xlab = "Age",ylab="Plasma glucose concentration")
